  ...
  return (
    <div className="jaf-form-container">
      ...
      <form className="jaf-form">
        ...
        />
        <TextField required id="email-address" label="Email Address" />
        ...
        <div className="jaf-subtitle">Contact Details</div>
        <br />
        <div className="jaf-form-subtitle">Head HR</div>

        <TextField required id="head-hr-name" label="Name" />
        <TextField required id="head-hr-email-address" label="Email" />
        <TextField
          id="head-hr-mobile"
          label="Mobile"
          type="number"
        ...
        <TextField required id="first-contact-name" label="Name" />
        <TextField required id="first-contact-email-address" label="Email" />
        <TextField
        ...
        <TextField required id="second-contact-name" label="Name" />
        <TextField required id="second-contact-email-address" label="Email" />
        <TextField
        ...
        <FormControl style={{ minWidth: "40%", margin: "20px" }}>
          <FormLabel id="bond-radio-buttons-group-label">
        ...
        <div className="jaf-form-submit">
          <button className="jaf-form-button">Submit</button>
        </div>
      </form>
    </div>
  );
